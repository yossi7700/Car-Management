  ...
  return (
    <div className="search-car-container">
      ...
      <nav className="navigation-menu">
        <ul>
          <li>
            <button onClick={() => navigate('/')}>Search Car</button>
          </li>
          {isAuthenticated && (
            <>
              <li>
              ...
              <li>
                <button onClick={() => navigate('/car-list')}>List of All Cars</button>
              </li>
              {localStorage.getItem('role') === 'superadmin' && (
                <li>
                  <button onClick={() => navigate('/superadmin')}>Super Admin Dashboard</button>
                </li>
              )}
              <li>
                <button onClick={() => {
